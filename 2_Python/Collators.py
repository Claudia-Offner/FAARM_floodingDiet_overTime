...
class Extractor:
    ...
    def nested_json_to_df(self, main_props, nested_feature, nested_props):
        ...
        df.rename(columns={'enum_c_cod': 'c_code', 'date': 'dov', 'c_Areakm2': 'c_area'}, inplace=True)
...
class Panelist:
    ...
    def get_panels(self):
        ...
        rounds = {'P0': ['2015-01-01', '2015-06-30'],  # baseline
                  ...
                  'P9': ['2019-07-01', '2019-12-31'],  # endline
                  'P10': ['2020-01-01', '2020-06-30']}
        ...
        panel_categories = ['P0', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8', 'P9', 'P10']
        ...
        # rounds = {'PRE': ['2015-01-01', '2015-03-13'],
        #           'BL': ['2015-03-14', '2015-05-14'],  # baseline
        #           # Year 1
        #           'R1': ['2015-09-09', '2015-10-29'],
        #           'R2': ['2015-11-28', '2015-12-28'],
        #           'R3': ['2016-01-21', '2016-02-28'],
        #           'R4': ['2016-03-22', '2016-04-30'],
        #           'R5': ['2016-05-24', '2016-06-28'],
        #           'R6': ['2016-07-21', '2016-08-24'],
        #            # Year 2
        #           'R7': ['2016-09-21', '2016-10-30'],
        #           'R8': ['2016-11-22', '2016-12-29'],
        #           'R9': ['2017-01-02', '2017-03-02'],
        #           'R10': ['2017-04-22', '2017-05-02'],
        #           'R11': ['2017-05-22', '2017-06-21'],
        #           'R12': ['2017-07-23', '2017-08-28'],
        #            # Year 3
        #           'R13': ['2017-09-25', '2017-11-02'],
        #           'R14': ['2017-11-23', '2017-12-31'],
        #           'R15': ['2018-01-22', '2018-02-28'],
        #           'R16': ['2018-03-21', '2018-04-30'],
        #           'R17': ['2018-05-23', '2018-07-02'],
        #           'R18': ['2018-07-24', '2018-09-01'],
        #            # Year 4
        #           'R19': ['2018-09-20', '2018-10-25'],
        #           'R20': ['2018-11-22', '2018-12-26'],
        #           'R21': ['2019-01-23', '2019-02-24'],
        #           'R22': ['2019-03-18', '2019-04-29'],
        #           'R22': ['2019-05-12', '2019-06-25'],
        #           'R24': ['2019-07-17', '2019-09-12'],
        #           'EL': ['2019-10-01', '2020-02-19'],
        #           'POST': ['2020-02-20', '2020-06-30']}
