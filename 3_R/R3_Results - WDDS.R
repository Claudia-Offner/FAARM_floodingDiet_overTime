...
extract_LME('dd10r_score_m', 'm_3/')
extract_LME('dd10r_score_m', 'm_2_seas/')
extract_LME('dd10r_score_m', 'm_2_treat/')
extract_LME('dd10r_score_m', 'm_0/')


# Example Interaction Model - notes ####
